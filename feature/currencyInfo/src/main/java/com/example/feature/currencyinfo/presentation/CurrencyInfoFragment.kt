...
import com.example.feature.currencyinfo.presentation.CurrencyInfoFragment.Companion.TAG
import com.example.feature.currencyinfo.presentation.ui.CurrencyListView
import com.example.feature.currencyinfo.presentation.ui.CurrencySearchBar
...
class CurrencyInfoFragmentFactoryImpl @Inject constructor() : CurrencyInfoFragmentFactory {
    ...
    override fun createFragment(groupId: Int?): Fragment = CurrencyInfoFragment.newInstance(groupId)
}
