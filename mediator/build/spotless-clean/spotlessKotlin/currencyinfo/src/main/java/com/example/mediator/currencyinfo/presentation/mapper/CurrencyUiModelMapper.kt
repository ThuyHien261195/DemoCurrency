...
fun CurrencyInfoModel.toCurrencyInfoUiModel(): CurrencyInfoUiModel = CurrencyInfoUiModel(
    id = id,
    name = name,
    symbol = symbol,
    code = code,
...
fun CurrencyInfoUiModel.toCurrencyInfoModel(): CurrencyInfoModel = CurrencyInfoModel(
    name = name,
    symbol = symbol,
    code = code,
)

fun CurrencyGroupModel.toCurrencyGroupUiModel(): CurrencyGroupUiModel = CurrencyGroupUiModel(
    id = id,
    groupName = groupName,
